...
import { DatabaseConnectionOptions } from 'src/common/configdatabase/DatabaseConnectionOptions'
...
@Module({
    imports: [
        TypeOrmModule.forRoot({ ...DatabaseConnectionOptions.getConnectionOptions() }),
        TypeOrmModule.forFeature([PersonDAO, AddressDAO, ProductDAO, CategoryDAO, AuthDAO]),
        JwtModule.register({
    ...
    providers: [PersonManager, AuthManager, AppService, AddressManager, ProductManager, AuthManager, CategoryManager, JwtService, LocalStrategy, JwtStrategy],
})
